...
class AndroidProjectTests(unittest.TestCase):
    ...
    def test_dual_core_and_locales(self):
        ...
        self.assertNotIn("INCLUDE_ZIG_CORE", gradle)
        self.assertIn('jniLibs.excludes += "**/libshadow6_zig.so"', gradle)
    ...
    def test_security_boundaries(self):
        ...
        self.assertNotIn("AccessMode", core)
        self.assertNotIn('ProcessBuilder("su"', core)
        ...
        self.assertNotIn('"zig"', cross_build)
        self.assertNotIn("Core-Zig", cross_build)
        self.assertNotIn("CoreEngine.ZIG", core)
