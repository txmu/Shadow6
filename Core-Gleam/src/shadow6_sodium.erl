...
-nifs([reserve_nonce/2, verify_mac/3, verify_ed25519/3, decrypt/5, encrypt/4, x25519/2,
       x25519_base/1, hmac_sha256/2, keypair/0, sha256/1, sha1/1, random_bytes/1,
       sign_ed25519/2, read_secure/1]).
-export([load/0, reserve_nonce/2, verify_mac/3, verify_ed25519/3, decrypt/5, encrypt/4,
         x25519/2, x25519_base/1, hmac_sha256/2, keypair/0, sha256/1, sha1/1,
         random_bytes/1, sign_ed25519/2, read_secure/1]).
...
x25519_base(_) -> erlang:nif_error(nif_not_loaded).
hmac_sha256(_, _) -> erlang:nif_error(nif_not_loaded).
...
reserve_nonce(_, _) -> erlang:nif_error(nif_not_loaded).
