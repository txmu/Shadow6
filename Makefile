...
ifeq ($(BUILD_IDRIS),1)
	...
	# BuildConfig values are reduced into downstream TTC files. Remove this
	# package's generated cache when switching variants; feature-report alone
	# cannot detect stale policy modules.
	@rm -rf Core-Idris/obj Core-Idris/build
