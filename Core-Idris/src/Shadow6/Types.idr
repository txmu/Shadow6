...
nonceFromCounter (p0 :: p1 :: p2 :: p3 :: []) value =
  let bits : Bits64 = cast value
  in [p0, p1, p2, p3, cast (bits .&. 0xff), cast ((bits `shiftR` 8) .&. 0xff), cast ((bits `shiftR` 16) .&. 0xff), cast ((bits `shiftR` 24) .&. 0xff), cast ((bits `shiftR` 32) .&. 0xff), cast ((bits `shiftR` 40) .&. 0xff), cast ((bits `shiftR` 48) .&. 0xff), cast ((bits `shiftR` 56) .&. 0xff)]
